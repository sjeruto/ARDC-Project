...
class LobbyistSaScrapper:
    ...
    def process_data_file(self):
        ...
        lobbyists_df.to_sql(engine, name = 'lobbyist_sa', index=False, if_exists='append')
        ...
        employees_df.to_sql(engine, name = 'lobbyist_sa_employee', index=False, if_exists='append')
        ...
        clients_df.to_sql(engine, name = 'lobbyist_sa_client', index=False, if_exists='append')
